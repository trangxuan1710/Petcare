...
public class CustomerController {
    ...
    @Operation(summary = "Tạo khách hàng mới", description = "Tạo hồ sơ chủ nuôi và nhập luôn thông tin thú cưng đầu tiên trong cùng một request")
    public ApiResponse<Client> createCustomer(@RequestBody Client request) {
